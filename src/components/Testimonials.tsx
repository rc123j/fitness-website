...
export default function Testimonials() {
  return (
    <section id="reviews" className="py-28 relative bg-white border-t border-[#1A1A1A]/12 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div 
              ...
              className="relative p-8 rounded-[36px] border border-black/12 bg-[#F9F7F3]/40 hover:bg-white hover:border-[#1A1A1A]/18 hover:shadow-2xl hover:shadow-black/[0.02] hover:-translate-y-1.5 transition-all duration-500 flex flex-col justify-between"
            >
              ...
              {/* Author Info */}
              <div className="flex items-center gap-3.5 pt-6 border-t border-[#1a1a1a]/12 z-10 relative">
