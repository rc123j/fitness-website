      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="flex items-center gap-2.5 mb-10">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-[8px] font-bold text-white/50 tracking-wider mt-1.5 uppercase">
        ...
        <div className="flex gap-6 mb-10">
          <a 
            href="https://www.instagram.com/fit_with_developer/" 
            target="_blank" 
            rel="noreferrer" 
          ...
          <a 
            href="mailto:support@fitwithdeveloper.com" 
            className="h-9 w-9 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all hover:translate-y-[-2px]"
          >
